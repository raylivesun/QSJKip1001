...
public abstract class Deprecation {
    ...
    public Deprecation(Object source, int type, int index0, int index1) {
        source.notifyAll();
    }
    ...
    public List<Value> getValues(int i, int i1) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    public void setValues(int i, List<? extends Value> list, int i1, int i2) throws InvalidTypeException, ClassNotLoadedException {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    public Value invokeMethod(ThreadReference tr, Method method, List<? extends Value> list, int i) throws InvalidTypeException, ClassNotLoadedException, IncompatibleThreadStateException, InvocationException {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
